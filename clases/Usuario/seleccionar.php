...
<body>
    ...
    <table>
        <thead bgcolor="#8CAAF8">
            <tr>
                <th colspan="9">
                    <h2>Listado general de los usuarios del sistema</h2>
                </th>
        ...
        <tbody>
            ...
            <?php foreach($datos as $row) { ?>
                <tr>
                    ...
                    <th>
                        <a href="editar.php?cod=<?php echo $row['correo_electronico'];?>"><img src="../../imagenes/editar.png" alt=""></a>
                    </th>
                    <th>
                        <a href="eliminar.php?cod=<?php echo $row['correo_electronico'];?>" onclick='return confirmacion()'><img src="../../imagenes/dele.png" alt=""></a>
                    </th>
                </tr>
            <?php } ?>
